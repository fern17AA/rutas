$(function () {
        ...
        function appendResults(distance_in_kilo, distance_in_mile, duration_text) {
            ...
            $('#in_mile').html(" Distancia en Millas: <span class='badge badge-pill badge-secondary'>" + distance_in_mile.toFixed(2) + "</span>");
            $('#in_kilo').html("Distancia en KM: <span class='badge badge-pill badge-secondary'>" + distance_in_kilo.toFixed(2) + "</span>");
            $('#duration_text').html("Duración: <span class='badge badge-pill badge-success'>" + duration_text + "</span>");
        }
